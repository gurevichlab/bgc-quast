...
sequence = str(record.seq)[:1000000]

# Save trimmed sequence
with open('trimmed_sequence.fasta', 'w') as f:
    f.write(f">{record.id}\n{sequence}\n")

# Function to split sequence into n contigs
def split_into_contigs(seq, n_contigs):
