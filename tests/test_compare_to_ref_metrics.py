...
import pytest
from bgc_quast.compare_to_ref_data import Intersection, RecoveryContiguity, ReferenceBgc, Status
from bgc_quast.genome_mining_result import Bgc, GenomeMiningResult
from bgc_quast.reporting.metrics import GROUPING_REGISTRY
from bgc_quast.reporting.metrics_calculators import CompareToRefMetricsCalculator
